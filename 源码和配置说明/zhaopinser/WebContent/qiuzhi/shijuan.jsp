...
<script type="text/javascript">
	...
	function formatPrice(shijuanId, row) {  
	    return '<a style="color:red;"target="_blank" href="../juantiNeirongList?shijuanId=' + shijuanId + '">查看试题' + '</a>';  
	}
	 ...
	 pagination="true" rownumbers="true" url="../shijuanList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="shijuanId" width="50" formatter="formatPrice" >查看试题</th>
		...
		<form id="fm" method="post">
			<table>
				<tr>
					...
					<td></td>
					<td>备注：</td>
					<td><input type="text" name="shijuanMark" id="shijuanMark" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>职位：</td>
