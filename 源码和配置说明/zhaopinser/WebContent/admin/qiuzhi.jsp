...
<body style="margin: 5px;">
	 ...
	 pagination="true" rownumbers="true" url="../qiuzhiList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="qiuzhiType" width="50">状态</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:openQiuzhiAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
			<a href="javascript:openQiuzhiModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
			<a href="javascript:deleteQiuzhi()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
		</div>
	</div>
	...
	<div id="dlg" class="easyui-dialog" style="width: 500px;height: 160px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td>名称：</td>
					<td><input type="text" name="qiuzhiName" id="qiuzhiName" class="easyui-validatebox" required="true"/></td>
					<td></td>
					<td>备注：</td>
					<td><input type="text" name="qiuzhiNum" id="qiuzhiNum" class="easyui-validatebox" required="true"/></td>
				</tr>
				<tr>
					<td>职位：</td>
					<td><input class="easyui-combobox" id="zhiweiId" name="zhiweiId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'userId',textField:'userXingming',url:'../userComboList'"/></td>
					<td></td>
					<td></td>
					<td></td>
				</tr>
