...
<script type="text/javascript">
	...
	function formatUrl(userZhaopian, row) {  
	    return '<img src="../upload/' + userZhaopian + '" width="100" height="100">';  
	}
...
<body style="margin: 5px;">
	<table id="dg" title="用户信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="../userList?roleId=1" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="userId" width="50">序号</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openUserAddDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">添加</a>
